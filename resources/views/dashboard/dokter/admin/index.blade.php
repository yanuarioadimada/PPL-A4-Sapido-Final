<x-dashboard-layout>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div> 
            <h4 class="text-3xl font-bold text-gray-800 mb-2">Dokter</h4>
            <p class="mb-4 text-xl font-bold text-gray-500">- Admin -</p>
        </div>
        <div class="w-100 mb-4 flex justify-end">
            <a href="{{route('dokter.create')}}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Tambah Data</a>
        </div>
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 text-center">
                        <a target="_blank" class="w-4" href="{{$item->foto_profil ? url($item->foto_profil) : ''}}">
                            @if($item->foto_profil)
                    ...
                    <td class="px-6 py-4 text-center">
                        ...
                        @else
                        <a href="{{route('dokter.edit',$item->id)}}" class="font-medium mr-2 text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
