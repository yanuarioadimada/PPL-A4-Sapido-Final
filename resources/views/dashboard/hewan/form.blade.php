...
<form action="{{route('hewan.store')}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        <div>
            ...
            <input name="nomor_hewan" type="text" id="nomor_hewan" class="{{$errors->has('nomor_hewan') ? 'bg-red-50 border border-red-500 text-red-900 placeholder-red-700 text-sm rounded-lg focus:ring-red-500  focus:border-red-500 block w-full p-2.5  ' : 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5'}} " placeholder="ID Hewan" required />
        ...
        <div>
            <label for="nomor_induk" class="{{$errors->has('nomor_induk') ? 'text-red-700' : 'text-gray-900'}} block mb-2 text-sm font-medium">ID Induk</label>
            <select name="id_induk" id="nomor_induk" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option value="" selected>Pilih ID Induk</option>
    ...
    <div class="mb-6">
        <label for="kelompok" class="{{$errors->has('id_profile') ? 'text-red-700' : 'text-gray-900'}} block mb-2 text-sm font-medium">Kelompok Ternak</label>
        <select name="id_profile" id="kelompok" class="{{$errors->has('nomor_hewan') ? 'bg-red-50 border border-red-500 text-red-900 placeholder-red-700 text-sm rounded-lg focus:ring-red-500  focus:border-red-500 block w-full p-2.5  ' : 'bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5'}} ">
            <option selected>Pilih kelompok ternak</option>
