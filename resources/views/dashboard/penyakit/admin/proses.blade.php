<x-dashboard-layout>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="p-5"> 
            <h4 class="text-3xl font-bold text-gray-800 mb-2">Penyakit - Proses</h4>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 text-right">
                            ...
                            <form action="{{route('admin.penyakit.update',$item->id)}}" method="POST" class="inline mr-4">
                                @csrf
                                @method('PATCH')
                            ...
                            <form action="{{route('admin.penyakit.update',$item->id)}}" method="POST" class="inline">
                                @csrf
                                @method('PATCH')
