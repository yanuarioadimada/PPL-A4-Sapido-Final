<x-app-layout>
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg p-10 m-4 bg-white">
        <div style="background-image: url({!! asset('img/cover-kelahiran.png') !!}); background-size: cover;">
            <h4 class="text-3xl font-bold text-white mb-4 p-10">Kelahiran & Kematian</h4>
        </div>
        <div class="w-100 mb-4 flex justify-end">
            <a href="{{route('kelahiran-kematian.create')}}" type="button" class="text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Tambah</a>
        </div>
            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 text-center">
                        ...
                        @else
                        <a href="{{route('kelahiran-kematian.edit',$item->id)}}" class="font-medium mr-2 text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                        <form action="{{route('kelahiran-kematian.destroy',$item->id)}}" method="post" class="inline">
                            @csrf
                            @method('delete')
